...
public class AnalizadorLexico {
	...
	// Warnings
	public static final String WARNING_IDENTIFICADOR = "Warning - Identificador muy largo en l�nea ";
	public static final String WARNING_CONSTANT_UI = "Warning - Constante entera sin signo fuera de rango en l�nea ";
	public static final String WARNING_CONSTANT_DOUBLE = "Warning - Constante double fuera de rango en l�nea ";

	// Errores
	public static final String ERROR_CARACTER_NO_RECONOCIDO = "Error - Caracter no reconocido en l�nea ";
	public static final String ERROR_CONSTANTE_MAL_DECLARADA = "Error - Constante mal declarada en l�nea ";
	public static final String ERROR_CONSTANTE_ENTERA_MAL_DECLARADA = "Error - Constante entera sin signo mal declarada en l�nea ";
	public static final String ERROR_CONSTANTE_DOUBLE_MAL_DECLARADA = "Error - Constante double mal declarada en l�nea ";
	public static final String ERROR_IDENTIFICADOR_MAL_DECLARADO = "Error - Identificador mal declarado en l�nea ";
	public static final String ERROR_PALABRA_RESERVADA_MAL_DEFINIDA = "Error - Palabra reservada mal definida en l�nea ";
	public static final String ERROR_CADENA_MAL_DEFINIDA = "Error- Cadena mal definida en l�nea ";
	...
	/**
	 * Devuelve a la entrada el �ltimo caracter le�do
	 */
	public void unget() {
		this.fh.goBack();
	}
	...
	/**
	 * Retorna el caracter le�do actualmente.
	 * @return
	 */
	...
	public void printWarnings() {
		...
		if (this.warnings.size() > 0) {
			...
			System.out.println("No hay warnings l�xicos");
	}
	...
	public void printErrors() {
		...
		if (this.errors.size() > 0) {
			...
			System.out.println("No hay errores l�xicos");
	}
	...
	public void printTablaSimbolos() {
		System.out.println("\n");
		System.out.println("Archivo CSV generado para la tabla de simbolo \n" );
		this.table.print();
	}
